...
WHAT THIS IS FOR. `cne mcp --live` lets someone try the agent surface without
first spending hours on `cne init`. It is the on-ramp, not the destination.
...
LIVE_WARNING = (
    ...
    "screen, not as research data. Build a lake (`cne init`) for anything that "
