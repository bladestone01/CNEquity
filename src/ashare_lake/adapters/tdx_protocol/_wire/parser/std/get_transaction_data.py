...
:mod:`ashare_lake.adapters.tdx_protocol._decode` therefore does not apply here.
"""

import struct
from collections import OrderedDict

from ashare_lake.adapters.tdx_protocol._wire.helper import get_price, get_time
from ashare_lake.adapters.tdx_protocol._wire.parser.base import BaseParser
