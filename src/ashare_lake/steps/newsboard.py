...
from ashare_lake.adapters.eastmoney.economic_calendar import fetch_economic_calendar
...
from ashare_lake.steps.http_common import empty_ok, run_incremental_fetched, write_fetched
