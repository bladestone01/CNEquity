...
from ashare_lake.adapters.tdx_protocol.client import fetch_trade_ticks_batch, normalize_with_source
from ashare_lake.config import Config
from ashare_lake.domain.datasets import get_dataset
from ashare_lake.orchestrator.registry import register_step
from ashare_lake.steps.common import incremental_window
...
def resolve_scope(config: Config) -> list[str]:
    ...
    if scope == "watchlist":
        ...
        from ashare_lake.steps.intraday import _index_members
