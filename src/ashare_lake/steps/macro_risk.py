...
def step_macro_indicators(config: Config, trade_date: date, run_id: str, context: dict) -> dict:
    return run_incremental_fetched(
        ...
        # The adapter stamps `source` per row (EastMoney vs akshare feed this
        # dataset), and with_provenance keeps a pre-set column. This value only
        # applies to the empty-frame case.
        source="eastmoney",
        allow_empty=True,
    )
