...
- CLI (`sde`) for `init`, `run daily`, `backfill`, `compact`, `derive`, `audit`,
...
- Project URLs point at `rootSunc/stock-data-engine`

[0.1.0]: https://github.com/rootSunc/stock-data-engine/releases/tag/v0.1.0
